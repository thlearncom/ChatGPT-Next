...
export const CN_MASKS: BuiltinMask[] = [
    ...
    context: [
      {
        ...
        date: "",
        role: "user",
        content: "Please translate following sentence to English:"
      }
    ],
    modelConfig: {
      model: "gpt-4-32k",
  ...
  },
  {
    ...
    context: [
      {
        id: "9DetVBE3HzU5L_f5c3Fw3",
        date: "",
        role: "user",
        content: "我希望您担任 IT 专家。我将为您提供有关我的技术问题所需的所有信息，您的角色是解决我的问题。你应该使用你的计算机科学，网络基础设施和IT安全知识来解决我的问题。在您的答案中为各个级别的人使用智能、简单和易于理解的语言会有所帮助。逐步解释您的解决方案并带有要点很有帮助。尽量避免太多技术细节，但在必要时使用它们。我希望你回复解决方案，而不是写任何解释。"
      }
    ],
    modelConfig: {
      model: "gpt-4-32k",
